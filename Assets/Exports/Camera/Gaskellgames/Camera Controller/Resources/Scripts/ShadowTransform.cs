...
namespace Gaskellgames.CameraController
{
    public class ShadowTransform : MonoBehaviour
    {
        ...
        [SerializeField] private Transform rotateWith;
        [SerializeField] private UpdateType updateType = UpdateType.Update;
        [SerializeField] private bool followX = true;
        [SerializeField] private bool followY = true;
        [SerializeField] private bool followZ = true;
        [SerializeField] private bool rotateWithX = true;
        [SerializeField] private bool rotateWithY = true;
        [SerializeField] private bool rotateWithZ = true;
        [SerializeField, Range(0, 1)] private float turnSpeed = 0.05f;
